...
어느 방법이든 4차 방정식의 해를 구하는 과정이 필요한데, 이는 일반적으로 수작업으로 해결하기 어렵다. 컴퓨터 대수 시스템\footnote{CAS, \emph{computer algebra system}}을 활용하여 해석적인 해를 구할 수는 있으나, 크나큰 이점은 없다. 따라서 수치적인 방법으로 근삿값을 찾는 것이 효율적이다.
