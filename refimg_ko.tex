...
어느 방법이든 4차 방정식의 해를 구하는 과정이 필요한데, 이는 일반적으로 수작업으로 해결하기 어렵다. 따라서 컴퓨터 대수 시스템\footnote{CAS, \emph{computer algebra system}}을 활용하여 해석적인 해를 구하거나,  수치적인 방법으로 근삿값을 찾는 것이 효과적이다.
