...
Either method requires solving a quartic equation, which is generally difficult to solve manually. Although analytical solutions can be obtained using a computer algebra system(CAS), there is no significant advantage. Therefore, it is more efficient to find approximate values using numerical methods.
